...
_MATH			= ft_itoa.c ft_uitoa.c ft_llitoa.c ft_atoi.c ft_pow.c
_STR			= ft_strdup.c ft_split.c ft_split_charset.c ft_split_spaces.c ft_strlen.c ft_strnstr.c ft_strcpy.c ft_substr.c ft_strjoin.c ft_strmjoin.c ft_strmapi.c ft_strrchr.c ft_strlcat.c ft_strstr.c ft_strchr.c ft_strlcpy.c ft_strncmp.c ft_strtrim.c ft_strupcase.c ft_strlowcase.c ft_strcapitalize.c
